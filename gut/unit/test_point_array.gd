...
func test_material_override_add_delete():
	...
	assert_true(mmat1.is_connected("changed", Callable(pa, "_on_material_override_changed")))
	assert_true(mmat2.is_connected("changed", Callable(pa, "_on_material_override_changed")))
	...
	assert_false(mmat1.is_connected("changed", Callable(pa, "_on_material_override_changed")))
	assert_true(mmat2.is_connected("changed", Callable(pa, "_on_material_override_changed")))
	...
	assert_false(mmat1.is_connected("changed", Callable(pa, "_on_material_override_changed")))
	assert_false(mmat2.is_connected("changed", Callable(pa, "_on_material_override_changed")))
